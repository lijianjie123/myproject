				...
				<div class="gray-box">
					...
					<div class="box-inner"> 
						<div class="order-discount-line"> 
							...
							<p> 运费： <span>+ ¥ {{yunfei}}.00</span> </p>  
							<p class="discount-line js-discount-cash"> <em>现金券</em>： <span> - 0 </span> </p>  
						</div> 
					</div>
					<div class="box-inner"> 
						<div class="last-payment clear"> 
							<span class="jianguo-blue-main-btn big-main-btn payment-blue-bt fn-right js-checkout"> <a>提交订单</a> </span> <span class="prices fn-right">应付金额： <em>¥ {{totalPrice+yunfei}}.00</em></span> 
						</div> 
					</div>
				</div>
			</div>
